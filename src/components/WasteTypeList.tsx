  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-col gap-3 mb-4">
        <h2 className="text-xl font-semibold text-foreground tracking-wide">危废类别</h2>
        
        {/* Compact iPad-style Segmented Control */}
        <div className="bg-muted p-1 rounded-xl shadow-inner backdrop-blur-sm border border-border">
      ...
      <div className="flex-1 overflow-y-auto space-y-2 px-1 py-1 scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300 hover:scrollbar-thumb-gray-400">
      ...
      <div className="mt-3 pt-3 border-t border-border">
        <div className="bg-card/50 rounded-lg p-3 backdrop-blur-sm border border-border">
          <div className="flex justify-between items-center text-center">
            ...
            <div className="flex items-center gap-2">
              <div className={`text-lg font-bold ${selectedId ? 'text-safety-green' : 'text-muted-foreground'}`}>
                {selectedId ? '✓' : '○'}
              </div>
