    ...
    <div className="flex flex-col h-full bg-background overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
            ...
            <div className="flex items-center gap-4">
              <div className="w-8">
                <input
                  ...
                  className="w-6 h-6 rounded border-border bg-background text-industrial-blue 
                           focus:ring-industrial-blue focus:ring-2 focus:ring-offset-0"
                />
              </div>
              <div className="flex-1 grid grid-cols-6 gap-4 text-lg font-bold text-muted-foreground">
                <div>危废名称</div>
                <div>记录ID</div>
                <div>重量 (KG)</div>
                <div>打印时间</div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 grid grid-cols-6 gap-4 items-center">
                    ...
                    {/* Unique ID */}
                    <div className="text-lg font-mono text-muted-foreground font-medium">
                      {record.uniqueId}
                    </div>
        ...
        {showSidePanel && selectedRecord && (
          <div className="w-[35%] bg-background/80 backdrop-blur-md border-l border-border/30 flex flex-col">
            {/* Panel Header */}
            ...
            <div className="flex-1 p-6 space-y-6 overflow-y-auto">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">记录ID</label>
                  <div className="text-foreground font-mono bg-background/60 backdrop-blur-sm px-3 py-2 rounded-lg border border-border/20">
